...
INPUTS_CALCULATION_MODULE = [
    ...
    {'input_name': 'Scale up or down the reduction of floor area compared to reference scenario: Constr. period before 1975',
     'input_type': 'input',
    ...
    {'input_name': 'Scale up or down the reduction of floor area compared to reference scenario: Constr. period 1975-1990',
     'input_type': 'input',
    ...
    {'input_name': 'Scale up or down the reduction of floor area compared to reference scenario: Constr. period after 1990',
     'input_type': 'input',
    ...
    {'input_name': 'Scale up or down the reduction of specific energy needs compared to reference scenario: Constr. period before 1975',
     'input_type': 'input',
    ...
    {'input_name': 'Scale up or down the reduction of specific energy needs compared to reference scenario: Constr. period 1975-1990',
     'input_type': 'input',
    ...
    {'input_name': 'Scale up or down the reduction of specific energy needs compared to reference scenario: Constr. period after 1990',
     'input_type': 'input',
